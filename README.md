...
This is a fork which adds an extra parameter ```-o organisation``` to be used in the dictionary attacks against S3 buckets
...
## Usage:
    ...
    usage: AWSBucketDump.py [-h] [-D] [-t THREADS] -l HOSTLIST [-o organisation] [-g GREPWORDS] [-m MAXSIZE]
